...
export default function Sistema35() {
    ...
    <div className="min-h-screen flex flex-col bg-slate-50">
      ...
      <div className="bg-gradient-to-br from-slate-900 to-slate-800 py-20 text-white">
        <div className="container-custom text-center">
          ...
          <h1 className="text-4xl md:text-5xl font-display font-bold mb-6">Sistema 3.5</h1>
        </div>
      </div>
              ...
              <CardContent className="space-y-6">
                <div className="space-y-4">
                  <div className="bg-slate-50 p-4 rounded-xl border border-slate-100">
                    ...
                    <p className="font-bold text-lg text-slate-800">$350 MXN</p>
                  </div>
